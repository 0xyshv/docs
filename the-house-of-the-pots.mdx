...
<AccordionGroup>
  <Accordion icon="book" title="Example">
  - 100 noblemen each deposit 1000 USDe.
  - A 10% loss pot means 100 USDe goes to the victors.
  - If there are 10 champions, they each receive 20 USDe (10 from deposit + 10 from the treasury) + staking rewards.
